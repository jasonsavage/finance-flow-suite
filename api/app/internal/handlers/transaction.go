...
func (h *TransactionHandler) UploadTransactions(w http.ResponseWriter, r *http.Request) {
	...
	transactions, err := helpers.ParseTransactionsCSV(file, accountID, bankAccountName)
	if err != nil {
...
func (h *TransactionHandler) ListTransactions(w http.ResponseWriter, r *http.Request) {
	...
	transactions, err := h.Repo.GetTransactions(r.Context(), accountID, fromTime, toTime)
	if err != nil {
